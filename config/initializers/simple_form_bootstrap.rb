...
SimpleForm.setup do |config|
  ...
  config.wrappers :normal_vertical_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :chosen, tag: 'div', class: 'form-group chosen', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :inline_radio, tag: 'div', class: 'radio-inline form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly

    b.use :label, class: 'col-sm-9 control-label'
